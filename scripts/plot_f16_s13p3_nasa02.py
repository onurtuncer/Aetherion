...
Outputs (figures/ sub-directory next to this script, or doc/figures/f16_s13p3/):
...
_BUILD_NASA = _HERE / "Atmos_13p3_sim_02.csv"
...
if _IN_BUILD_DIR:
    ...
    NASA_CSV = _REPO / "data" / "Atmos_13p3_SubsonicHeadingChangeF16" / "Atmos_13p3_sim_02.csv"
    OUT_DIR  = _REPO / "doc" / "figures" / "f16_s13p3"
...
def overview(t, sim_df, ref_df):
    ...
    fig.suptitle("Aetherion F-16 Scenario 13.3 — Full Channel Comparison vs NASA Atmos_13p3_sim_02",
