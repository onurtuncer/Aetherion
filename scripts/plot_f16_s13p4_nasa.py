"""
plot_f16_s13p4_nasa.py
Copyright (c) 2025-2026, Onur Tuncer, PhD, Istanbul Technical University

Documentation-quality comparison of the Aetherion F-16 Scenario 13.4
closed-loop simulation against the NASA TM-2015-218675 Atmos_13p4_sim_05
...
-----
Source-tree:
    python scripts/plot_f16_s13p4_nasa.py [sim_csv] [nasa_ref]

Build directory (after CMake copies this script next to the executable):
    python plot_f16_s13p4_nasa.py [sim_csv] [nasa_ref]
...
Outputs (doc/_static/f16_s13p4/ or build-dir figures/f16_s13p4/):
...
_BUILD_NASA = _HERE / f"Atmos_13p4_sim_{NASA_REF}.csv"
...
if _IN_BUILD_DIR:
    ...
    NASA_CSV = _REPO / "data" / "Atmos_13p4_SubsonicLateralSideStepF16" / f"Atmos_13p4_sim_{NASA_REF}.csv"
...
def overview(t, sim_df, ref_df):
    ...
    fig.suptitle(f"Aetherion F-16 Scenario 13.4 — Full Channel Comparison vs NASA Atmos_13p4_sim_{NASA_REF}",
