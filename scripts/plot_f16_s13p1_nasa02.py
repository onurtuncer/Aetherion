...
12 ft altitude error).  The default sim CSV is produced by:
...
# ── Plot style (shared with Case 11 script) ───────────────────────────────────
...
def main():
    ...
    out = multi_panel(t, [
        ...
        ("mach",             "Mach",          "-",   1.0),
    ], sim_df, ref_df, "Scenario 13.1 — Flight Envelope", "fig_flight_envelope.png")
    print(f"  {out.name}")
    ...
    ], sim_df, ref_df, "Scenario 13.1 — Euler Attitude Angles", "fig_attitude.png")
    print(f"  {out.name}")
    ...
    ], sim_df, ref_df, "Scenario 13.1 — Body Angular Rates", "fig_body_rates.png")
    print(f"  {out.name}")
    ...
    ], sim_df, ref_df, "Scenario 13.1 — Geographic Position", "fig_position.png")
    print(f"  {out.name}")
    ...
    ], sim_df, ref_df, "Scenario 13.1 — NED Velocity", "fig_ned_velocity.png")
    print(f"  {out.name}")
    ...
    ], sim_df, ref_df, "Scenario 13.1 — Aerodynamic Body Forces", "fig_aero_forces.png")
    print(f"  {out.name}")
    ...
    ], sim_df, ref_df, "Scenario 13.1 — Aerodynamic Body Moments", "fig_aero_moments.png")
    print(f"  {out.name}")
    ...
    ], sim_df, ref_df, "Scenario 13.1 — Atmospheric State", "fig_atmosphere.png",
    h_per_row=2.1)
    print(f"  {out.name}")
