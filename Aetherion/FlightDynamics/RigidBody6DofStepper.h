...
//explicit RigidBody6DoFStepper(const RigidBody::InertialParameters& ip,
//ODE::RKMK::Core::NewtonOptions opt = {})
...
//[[nodiscard]]
//StepResult step(double t0, const RigidBody::StateD& s, double h) const
//{
//VecE x0;
...
//[[nodiscard]] static RigidBody::StateD unpack(const StepResult& r)
//{
//RigidBodyStateD s;
//s.g = r.g1;
