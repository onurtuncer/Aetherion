...
add_custom_target(
  ...
  COMMAND
    cppcheck-htmlreport --title="${CMAKE_PROJECT_NAME}" --file="${STATIC_ANALYSIS_XML_FILE}"
    --report-dir="${STATIC_ANALYSIS_REPORT_DIR}" --source-dir="${STATIC_ANALYSIS_SOURCE_DIR}" --source-encoding=UTF-8
