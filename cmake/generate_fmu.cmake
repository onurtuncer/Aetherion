...
# set(_fmu4cpp_cmake_dir "${CMAKE_CURRENT_LIST_DIR}") get_filename_component(_fmu4cpp_root "${_fmu4cpp_cmake_dir}/.."
# ABSOLUTE) set(_fmu4cpp_root "${_fmu4cpp_root}" CACHE INTERNAL "")
...
function(generateFMU modelIdentifier)
  ...
  foreach(fmiVersion IN LISTS FMU_FMI_VERSIONS)
    ...
    target_compile_definitions(${versionTarget} PUBLIC ${VERSION_DEFS} ${FMU_COMPILE_DEFINITIONS})
...
macro(_package_fmu)
  ...
  if(FMU_WITH_SOURCES AND fmiVersion STREQUAL "fmi3")
    list(
      ...
      "${modelOutputDir}/sources/buildDescription.xml")
  endif()
